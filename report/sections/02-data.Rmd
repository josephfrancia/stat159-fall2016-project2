...
```{r results='asis', echo=FALSE,warning =FALSE}
  print(xtable(as.data.frame(cor(data[, -c(7,8,9,10)])), caption="Correlation Matrix for the Quantitative Variables"), caption.placement='top', comment=F, scalebox='.75')
```
</td>
...
```{r results='asis', echo=FALSE,warning=FALSE}
  print(xtable(freq_ethnicity, caption="Frequency Table for Ethnicity Variable"), caption.placement='top', comment=F, scalebox='.75')
```
